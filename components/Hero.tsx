    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        <div className="text-center stagger-children">
          {/* Logo placeholders */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-12 mb-12 md:mb-16">
            {/* Tim Tebow Foundation Logo Placeholder */}
            <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-lg bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 flex items-center justify-center">
              <span className="text-xs sm:text-sm text-gray-500 font-semibold text-center px-4">TTF<br/>Logo</span>
            </div>

            {/* Medici Logo Placeholder */}
            <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-lg bg-gradient-to-br from-[#21CE99]/20 to-[#005d97]/20 border border-[#21CE99]/50 flex items-center justify-center glow-teal">
              <span className="text-xs sm:text-sm text-[#21CE99] font-semibold text-center px-4">Medici<br/>Logo</span>
            </div>
          </div>

          {/* Headline */}
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-6 md:mb-8 tracking-tight">
            Medici Day <span className="gradient-text">2026</span>
          </h1>

          {/* Subheadline */}
          <p className="text-xl sm:text-2xl md:text-3xl text-gray-300 font-light mb-8 md:mb-12 max-w-3xl mx-auto">
